...
def xgboost_evaluate(file):
    ...
    mid.columns = ['text']
    feature_path = '/Users/zhaoxinzhu/Desktop/feature.pkl'
    ...
    clf = XGBClassifier()
    booster = xgb.Booster()
    booster.load_model('/Users/zhaoxinzhu/Desktop/xgboost_classifier_model.model')
    clf._Booster = booster
    clf._le = LabelEncoder().fit([1,0])
    y_mid = clf.predict(test_tfidf,validate_features=False)
    f = open("/Users/zhaoxinzhu/Desktop/ans.txt","w")
